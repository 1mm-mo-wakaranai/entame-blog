...
{{< chat name="エンくん" icon="/images/en-icon.png" direction="left" >}}
映画と連動してるんだ！どういう楽しみ方がおすすめなの？
{{< /chat >}}

{{< chat name="タメちゃん" icon="/images/tame-icon.png" direction="right" >}}
映画の前に行けば予習になるし、映画の後に行けば装飾の意味がわかって二度楽しめるよ。4か月もあるから焦らなくて大丈夫！
{{< /chat >}}
...
{{< chat name="エンくん" icon="/images/en-icon.png" direction="left" >}}
人気イベントだと混みそうだけど、いつ行くのがいいかな？
{{< /chat >}}

{{< chat name="タメちゃん" icon="/images/tame-icon.png" direction="right" >}}
開催初日や夏休みの土日は混雑するから、平日か9月以降がおすすめだよ。グッズ狙いなら早めに行ってね！
{{< /chat >}}
...
{{< chat name="タメちゃん" icon="/images/tame-icon.png" direction="right" >}}
そうだね。映画と合わせて夏の思い出にぴったりだよ。公式SNSをフォローして最新情報をチェックしておこうね！
{{< /chat >}}
